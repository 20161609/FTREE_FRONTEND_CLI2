...
from api.transaction import delete_transaction, get_transaction_daily
    ...
    def get_transactions(self):
        ...
        if res.status_code == 200:
            ...
            for record in history:
                ...
                row = [tid, when, branch, 
                       format_cost(cashflow), 
                       description, c_date]
                self.rows.append(row)
        else:
            print(f"...[ERROR] Upload failed, {res.status_code}\n" + res.json()['detail'])
            return None
        ...
        if selected_item:
            ...
            if confirm:
                try:
                    ...
                    delete_transaction(id_token=self.id_token, tid=int(tid))
